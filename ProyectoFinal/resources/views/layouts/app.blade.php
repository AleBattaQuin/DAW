        ...
        <div>
            ...
            <ul class="nav justify-content-center" id="bordes">
                ...
                <li class="nav-item" id="boton">
                    <a class="nav-link" id="boton" aria-current="page" href="{{ route('home') }}">INICIO</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" id="boton" href="{{ route('rutas') }}">RUTAS</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" id="boton" href="{{ route('noticias') }}">NOTICIAS</a>
                </li>
