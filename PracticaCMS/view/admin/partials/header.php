    ...
    <div class="nav-wrapper">
        ...
        <?php if (isset($_SESSION['hobbit'])){ ?>
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                ...
                <?php if ($_SESSION['libros'] == 1){ ?>
                    <li>
                        <a href="<?php echo $_SESSION['home'] ?>admin/libros" title="Libros">Libros</a>
                    </li>
                <?php } ?>
                <?php if ($_SESSION['hobbits'] == 1){ ?>
                    <li>
                        <a href="<?php echo $_SESSION['home'] ?>admin/hobbits" title="Usuarios">Usuarios</a>
                    </li>
                <?php } ?>
                <li>
...
<main>
    ...
    <header>
        ...
        <?php if (isset($_SESSION['hobbit'])){ ?>
            ...
            <h2>
                Usuario: <strong><?php echo $_SESSION['hobbit'] ?></strong>
            </h2>
