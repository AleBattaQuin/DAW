<h3>
    <a href="<?php echo $_SESSION['home'] ?>admin" title="Inicio">Inicio</a> <span>| Libros</span>
</h3>
<div class="row">
    <!--Nuevo-->
        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/libros/crear" ?>" title="Añadir nuevo libro">
        ...
        <article class="col s12 l6">
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    ...
                    <div class="card-action">
                        <a href="<?php echo $_SESSION['home']."admin/libros/editar/".$row->id ?>" title="Editar">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/libros/activar/".$row->id ?>" title="<?php echo $title ?>">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/libros/home/".$row->id ?>" title="<?php echo $title ?>">
                ...
                <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">Borrar libro<i class="material-icons right">close</i></span>
                    <p>
                        ¿Está seguro de que quiere borrar el libro<strong><?php echo $row->titulo ?></strong>?<br>
                        Esta acción no se puede deshacer.
                    </p>
                    <a href="<?php echo $_SESSION['home']."admin/libros/borrar/".$row->id ?>" title="Borrar">
