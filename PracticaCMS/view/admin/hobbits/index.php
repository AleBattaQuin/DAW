        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/hobbits/crear" ?>" title="Añadir nuevo usuario">
            ...
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    <div class="card-content">
                        ...
                        <strong>Usuarios: </strong><?php echo ($row->hobbit) ? "Sí" : "No" ?><br>
                        <strong>Libros: </strong><?php echo ($row->libros) ? "Sí" : "No" ?>
                    </div>
                    <div class="card-action">
                        <a href="<?php echo $_SESSION['home']."admin/hobbits/editar/".$row->id ?>" title="Editar">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/hobbits/activar/".$row->id ?>" title="<?php echo $title ?>">
                ...
                <div class="card-reveal">
                    ...
                    <p>
                        ¿Está seguro de que quiere borrar al usuario<strong><?php echo $row->hobbit ?></strong>?<br>
                        Esta acción no se puede deshacer.
                    </p>
                    <a href="<?php echo $_SESSION['home']."admin/hobbits/borrar/".$row->id ?>" title="Borrar">
